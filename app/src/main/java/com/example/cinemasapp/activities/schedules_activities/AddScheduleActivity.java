...
public class AddScheduleActivity extends AppCompatActivity {
    ...
    private void loadElements() {
        displayedDate = findViewById(R.id.displayedDate);
        displayedTime = findViewById(R.id.displayedTime);
    ...
    private void add() {
        ...
        if (dbh.scheduleExists(selectedDate, selectedTime, selectedRoomId)) {
            Toast.makeText(this, "Room at this date and time is already taken", Toast.LENGTH_SHORT).show();
            return;
        }

        Schedule schedule = new Schedule(1,selectedMovieId, selectedRoomId, selectedDate, selectedTime, selectedFormat);
        dbh.addSchedule(schedule);
